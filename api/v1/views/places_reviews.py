...
@app_views.route('/reviews/<stateid>', strict_slashes=False,
                 methods=['GET', 'DELETE', 'PUT'])
def review_info(stateid):
...
@app_views.route("/reviews", strict_slashes=False, methods=['POST', 'GET'])
def reivews_list():
